...
//         SharpFactsAggregator.JobOutput memory output
//     ) internal view {
//         (
//             bytes32 poseidonMmrRoot,
//             bytes32 keccakMmrRoot,
...
//         SharpFactsAggregator.JobOutput[] memory outputs = abi.decode(
//             output,
//             (SharpFactsAggregator.JobOutput[])
//         );

//         SharpFactsAggregator.JobOutput memory firstOutput = outputs[0];
...
//         SharpFactsAggregator.JobOutput[] memory outputsExtended = abi
//             .decode(outputExtended, (SharpFactsAggregator.JobOutput[]));
